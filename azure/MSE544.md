...
- You should not need to do this (avoid random suggestions)
    ...
    - ...because there is **`requirements.txt`** as the way to go
...
The first tab of the wizard should look like this. Then just click on Review + create to skip all the other tabs, which include:    
...
kilroy you might explain the above three things just the same
