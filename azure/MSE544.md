...
* Jargon: *Stateless* means that the Azure Function always runs with no memory of what has happened in the past
...
When we do not seeing the view we need: We change the view. The view selector is a vertical strip
